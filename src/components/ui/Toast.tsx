...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={showToast}>
      {children}
      <div
        className={`absolute left-4.5 right-4.5 bottom-[70px] bg-heading text-white text-center py-2.5 rounded-lg text-[12.5px] font-bold pointer-events-none transition-all z-50 ${
