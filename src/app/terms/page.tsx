    ...
    <div className="min-h-full bg-paper text-ink">
      <div className="max-w-[720px] mx-auto px-6 py-12">
        ...
        <Section title="第3条(利用登録・アカウント)">
          <ul className="list-disc pl-5 space-y-1">
            <li>
              新たにチームを作成する場合、利用者は自らの申込みにより本サービス上でアカウントを登録し、チームを開設するものとします。既存のチームに参加する場合は、そのチームから発行された招待リンクを通じて利用登録を行うものとします。
            </li>
            <li>
            ...
            <li>
              選手が未成年者である場合、その保護者が招待リンクを通じてアカウントを作成し、当該選手の情報を本サービス上で閲覧・登録することをもって、当該保護者が本人(未成年者)に代わり、本規約およびプライバシーポリシーに定める当該選手の情報の取扱いに同意したものとみなします。
            </li>
          </ul>
        </Section>
        ...
        <Section title="第6条(利用料金)">
          <p>
            本サービスは、当運営者が別途定める有料プランを提供しています。有料プランの内容・料金・支払方法は、本サービス上に表示するものとし、利用者は表示された条件に同意のうえ申し込むものとします。有料プランの決済には、決済代行事業者(Stripe, Inc.)を利用します。
          </p>
        </Section>
