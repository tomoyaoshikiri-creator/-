            ...
            <tbody>
              {rows.map((r) => (
                <tr key={r.id}>
                  ...
                  <td className="px-2 py-1 min-w-[76px] text-center border-b border-line last:border-b-0 font-mono">
                    <div className="font-bold">{fgPct(r.line)}</div>
                  ...
                  {showThreePoint && (
                    <>
                      <td className="px-2 py-1 min-w-[76px] text-center border-b border-line last:border-b-0 font-mono">
                        <div className="font-bold">{twoPct(r.line)}</div>
                        <div className="text-ink-soft text-[10px]">
                          {r.line.fg_made - r.line.three_made}/{r.line.fg_att - r.line.three_att}
                        </div>
                      </td>
                      <td className="px-2 py-1 min-w-[76px] text-center border-b border-line last:border-b-0 font-mono">
                        <div className="font-bold">{threePct(r.line)}</div>
                        <div className="text-ink-soft text-[10px]">
                  ...
                  <td className="px-2 py-1 min-w-[76px] text-center border-b border-line last:border-b-0 font-mono">
                    <div className="font-bold">{ftPct(r.line)}</div>
                    <div className="text-ink-soft text-[10px]">
              ...
              <tr>
                ...
                <td className="px-2 py-1 min-w-[76px] text-center bg-paper font-mono">
                  <div className="font-bold">{fgPct(total)}</div>
                  <div className="text-ink-soft text-[10px]">
                ...
                {showThreePoint && (
                  <>
                    <td className="px-2 py-1 min-w-[76px] text-center bg-paper font-mono">
                      <div className="font-bold">{twoPct(total)}</div>
                      <div className="text-ink-soft text-[10px]">
                        {total.fg_made - total.three_made}/{total.fg_att - total.three_att}
                      </div>
                    </td>
                    <td className="px-2 py-1 min-w-[76px] text-center bg-paper font-mono">
                      <div className="font-bold">{threePct(total)}</div>
                      <div className="text-ink-soft text-[10px]">
                ...
                <td className="px-2 py-1 min-w-[76px] text-center bg-paper font-mono">
                  <div className="font-bold">{ftPct(total)}</div>
                  <div className="text-ink-soft text-[10px]">
                ...
                {showThreePoint && (
                  <>
                    <td className="px-2 py-1 min-w-[76px] text-center bg-paper font-mono">
                      <div className="font-bold">{twoPct(total)}</div>
                      <div className="text-ink-soft text-[10px]">
                        {avg(total.fg_made - total.three_made)}/{avg(total.fg_att - total.three_att)}
                      </div>
                    </td>
                    <td className="px-2 py-1 min-w-[76px] text-center bg-paper font-mono">
                      <div className="font-bold">{threePct(total)}</div>
