    ...
    <div className="min-h-full bg-paper text-ink">
      <div className="max-w-[720px] mx-auto px-6 py-12">
        ...
        <dl className="text-[12.5px] leading-relaxed">
          ...
          <Row label="販売価格">
            Standardプラン 月額980円(税込)/ 年払い9,800円(税込)
            <br />
            Proプラン 月額2,180円(税込)/ 年払い21,800円(税込)
            <br />
            Pro AI Plusプラン 月額2,980円(税込)/ 年払い29,800円(税込)
            <br />
            <span className="text-ink-soft">※年払いは月額の10ヶ月分の金額です(2ヶ月分お得)。各プランの内容は本サービス上に表示のとおりです。</span>
          </Row>
