    ...
    <div className="min-h-full bg-paper text-ink">
      <div className="max-w-[720px] mx-auto px-6 py-12">
        ...
        <dl className="text-[12.5px] leading-relaxed">
          ...
          <Row label="販売価格">
            Standardプラン 月額1,280円(税込)/ 年払い13,824円(税込)
            <br />
            Proプラン 月額2,480円(税込)/ 年払い26,784円(税込)
            <br />
            Pro AI Plusプラン 月額3,280円(税込)/ 年払い35,424円(税込)
            <br />
            <span className="text-ink-soft">※年払いは月払い12ヶ月分から10%割引した金額です。各プランの内容は本サービス上に表示のとおりです。</span>
          </Row>
          ...
          <Row label="お支払い時期">
            お申し込み時に決済されます。以降は月払いの場合は毎月、年払いの場合は毎年、同日に自動更新され、その都度自動的に決済されます。
          </Row>
