      ...
      <div className="max-w-[720px] mx-auto px-6 py-12">
        ...
        <Section title="3. 取得する情報">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              選手情報: 氏名、学年、ポジション、背番号、生年月日、身長・体重の記録、スポーツテスト結果、試合の出場記録・スタッツ、指導者による選手メモ・分析フィードバック(後述のAI分析機能による生成結果を含みます。本サービスは少年団・クラブチームに限らずご利用いただけるため、選手が未成年者である場合はその情報が含まれます)
            </li>
            <li>保護者と選手の紐付け情報</li>
            <li>予定・出欠登録、お知らせ、チーム日報、コーチ日報、ライブラリに共有した画像・資料、およびそれらへのコメント・スタンプの内容</li>
          </ul>
        </Section>
        ...
        <Section title="4. 利用目的">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>AI分析機能(選手・チームの成績データ等をもとに、生成AIを用いて分析コメントを作成する機能)を提供するため</li>
          </ul>
        </Section>
        ...
        <Section title="5. 第三者提供・業務委託">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Anthropic PBC(AI分析機能の提供。フルプラス以上のプランでAI分析機能をご利用いただいた場合、対象の選手・チームの氏名・学年・試合スタッツ・スポーツテスト結果等の成績データを、分析コメント生成のためAnthropic社のAPIへ送信します。対象選手が未成年者である場合、その情報が含まれます)
            </li>
            <li>Stripe, Inc.(有料プランの決済代行。カード情報等の決済に必要な情報を送信します)</li>
          </ul>
          <p className="mt-2">
        ...
        <Section title="6. 未成年者の情報の取扱いについて">
          <p>
            本サービスは少年団・クラブチームに限らずご利用いただけるサービスですが、選手情報には未成年者に関するものが含まれる場合があります。選手情報はチームの指導者・管理者権限を持つ利用者が登録し、保護者はチームから発行された招待リンクを通じてアカウントを作成のうえ、紐付けられた自分の子どもの情報のみ閲覧できます。選手情報の登録・修正・削除に関するご要望は、まず所属チームの管理者にご相談ください。
          </p>
          <p className="mt-2">
            選手が未成年者である場合、その保護者が招待リンクを通じてアカウントを作成し、当該選手の情報を閲覧・登録することをもって、当該保護者が本人(未成年者)に代わり、本ポリシーに定める個人情報の取扱いに同意したものとみなします。
          </p>
          <p className="mt-2">
            チームの管理者がAI分析機能を利用した場合、対象となった選手の情報がAnthropic社へ送信されます(詳細は「5. 第三者提供・業務委託」をご参照ください)。この機能の利用可否はチームの管理者の判断に委ねられています。
          </p>
        </Section>
