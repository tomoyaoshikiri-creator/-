      ...
      <div className="max-w-[720px] mx-auto px-6 py-12">
        ...
        <Section title="3. 取得する情報">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              選手情報: 氏名、学年、ポジション、背番号、生年月日、身長・体重の記録、スポーツテスト結果、試合の出場記録・スタッツ、指導者による選手メモ・分析フィードバック(後述のAI分析機能による生成結果を含みます。これらには未成年者に関する情報が含まれます)
            </li>
            <li>保護者と選手の紐付け情報</li>
        ...
        <Section title="5. 第三者提供・業務委託">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Anthropic PBC(AI分析機能の提供。フルプラス以上のプランでAI分析機能をご利用いただいた場合、対象の選手・チームの氏名・学年・試合スタッツ・スポーツテスト結果等の成績データを、分析コメント生成のためAnthropic社のAPIへ送信します。未成年者である選手に関する情報が含まれます)
            </li>
